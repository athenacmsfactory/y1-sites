# 📘 Handleiding: test-v9-portfolio

**Type Website:** v9-portfolio
...
| :--- | :--- |
| `naam` | Naam van de professional |
| `functie` | Huidige rol of expertise |
| `bio` | Korte bio |
| `profielfoto` | URL naar profielfoto |
...
| `categorie` | Type werk |
| `beschrijving` | Details over het werk |
| `afbeelding` | Project cover afbeelding |
...
| `rol` | Functie van de klant |
| `tekst` | De testimonial tekst |
